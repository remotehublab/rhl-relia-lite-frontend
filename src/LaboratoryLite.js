...
import { ReliaWidgets } from "./components/blocks/loaderDevelopmentLite";
import $ from "jquery";
...
function LaboratoryLite({
  ...
  return (
    <Container className={"laboratory-lite-container text-center"}>
      <Row>
      ...
      <Row id={"relia-widgets"}>
        <Col style={{ display: currentSession.assignedInstance != null ? "block" : "none" }}>
          <center>
            ...
            {currentSession.dataUrl != null && <h4>({currentSession.dataUrl})</h4>}
          </center>
...
export default withTranslation()(LaboratoryLite);
