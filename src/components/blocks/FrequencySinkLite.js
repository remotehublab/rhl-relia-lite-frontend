...
export class FrequencySinkLite extends ReliaWidgetLite {
  constructor($divElement, blockIdentifier, block) {
    ...
    self.$div.html(
      '<div class="freq-chart" style="width: 100%; height: 300px"></div>\n' +
        ...
        '<div class="col">' +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-grid-checkbox" checked>' +
        t("widgets.general.grid") +
        "</label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-autoscale-checkbox" checked>' +
        t("widgets.general.autoscale") +
        "</label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-axis-labels-checkbox" checked>' +
        t("widgets.general.axis-labels") +
        "</label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-1" checked>&nbsp;<span class="freq-sink-real-checkbox-1-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 1 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-2" checked>&nbsp;<span class="freq-sink-real-checkbox-2-1-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 2 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-3" checked>&nbsp;<span class="freq-sink-real-checkbox-3-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 3 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-4" checked>&nbsp;<span class="freq-sink-real-checkbox-4-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 4 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-5" checked>&nbsp;<span class="freq-sink-real-checkbox-5-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 5 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-6" checked>&nbsp;<span class="freq-sink-real-checkbox-6-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 6 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-7" checked>&nbsp;<span class="freq-sink-real-checkbox-7-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 7 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-8" checked>&nbsp;<span class="freq-sink-real-checkbox-8-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 8 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-9" checked>&nbsp;<span class="freq-sink-real-checkbox-9-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 9 }) +
        " </span></label>&nbsp;" +
        '<label class="checkbox"><input type="checkbox" class="checkbox freq-sink-real-checkbox-10" checked>&nbsp;<span class="freq-sink-real-checkbox-10-label" style="display: inline">' +
        t("widgets.general.channel-abbreviation", { count: 10 }) +
        " </span></label>&nbsp;" +
        "</div>" +
        '<div class="col">' +
    ...
    if (self.pausePlayFreqSink == true) {
      ...
      for (var index = 1; index <= nconnections; ++index) {
        ...
        if (self.$div.find(".freq-sink-real-checkbox-" + index).is(":checked")) {
          ...
          self.$div
            .find(".freq-sink-real-checkbox-" + index + "-label")
  ...
  translatedName() {
    return t("widgets.frequency-sink.name");
  }
}

export default FrequencySinkLite;
